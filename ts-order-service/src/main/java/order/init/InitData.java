...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args)throws Exception{
        ...
        order.setId(UUID.fromString("5ad7750b-a68b-49c0-a8c0-32776b067703").toString());
        ...
        orderTwo.setId(UUID.fromString("8177ac5a-61ac-42f4-83f4-bd7b394d0531").toString());
        ...
        orderThree.setId(UUID.fromString("d3c91694-d5b8-424c-9974-e14c89226e49").toString());
