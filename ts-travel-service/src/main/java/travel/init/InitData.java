...
public class InitData implements CommandLineRunner{
    ...
    public void run(String... args)throws Exception{
        ...
        info.setStartTime("2025-05-04 09:00:00"); //NOSONAR
        info.setEndTime("2025-05-04 15:51:52"); //NOSONAR
        ...
        info.setStationsName(suzhou);
        info.setTerminalStationName(taiyuan);
        info.setStartTime("2025-05-04 12:00:00"); //NOSONAR
        info.setEndTime("2025-05-04 17:51:52"); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsName(suzhou);
        info.setTerminalStationName(taiyuan);
        info.setStartTime("2025-05-04 14:00:00"); //NOSONAR
        info.setEndTime("2025-05-04 20:51:52"); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsName(suzhou);
        info.setTerminalStationName(taiyuan);
        info.setStartTime("2025-05-04 08:00:00"); //NOSONAR
        info.setEndTime("2025-05-04 17:21:52"); //NOSONAR
        service.create(info,null);
        ...
        info.setStationsName(suzhou);
        info.setTerminalStationName(taiyuan);
        info.setStartTime("2025-05-04 07:00:00"); //NOSONAR
        info.setEndTime("2025-05-04 19:59:52"); //NOSONAR
        service.create(info,null);
    }
}
